export const perks = {
        ...
        StrongBack: {
            ...
            ranks: [
                ...
                },
                {
                    perkRank: 4,
                    playerLevel: 30,
                    description: "When overencumbered, you can fast travel (Normal mode). When overencumbered, you will not become injured (Survival mode)."
                },
                {
                    perkRank: 5,
                    playerLevel: 40,
        ...
        SteadyAim: {
            ...
            ranks: [
                ...
                },
                {
                    perkRank: 3,
                    playerLevel: 49,
                    description: "Hip-fire damage is improved when firing any gun."
                }
            ]
        },
        Basher: {
        ...
        Awareness: {
            ...
            ranks: [
                ...
                },
                {
                    perkRank: 2,
                    playerLevel: 14,
                    description: "Knowing their weaknesses lets you attack more efficiently. 5% increase to hit chance and damage dealt to VATS targets."
                }
            ]
        },
        Locksmith: {
            ...
            ranks: [
                {
                    perkRank: 1,
                    playerLevel: 0,
                    description: "You are a creature of the night! Gain +2 to Intelligence and Perception between the hours of 6:00 PM and 6:00 AM."
                },
                {
                    perkRank: 2,
                    playerLevel: 25,
                    description: "You now have +3 to Intelligence and Perception between the hours of 6:00 PM and 6:00 AM, and night vision when sneaking."
                },
                {
                    perkRank: 3,
                    playerLevel: 37,
                    description: "You have 30 extra health between the hours of 6:00 PM and 6:00 AM."
                }
            ]
        },
        Refractor: {
        ...
        Sniper: {
            ...
            ranks: [
                ...
                },
                {
                    perkRank: 2,
                    playerLevel: 13,
                    description: "Non-automatic, scoped rifles have a chance of knocking down your target. Chance is 15%."
                },
                {
                    perkRank: 3,
                    playerLevel: 26,
        ...
        RadResistant: {
            ...
            ranks: [
                ...
                },
                {
                    perkRank: 4,
                    playerLevel: 35,
                    description: "You now have +40 Radiation Resistance."
                }
            ]
        },
        AdamantiumSkeleton: {
        ...
        Ghoulish: {
            ...
            ranks: [
                ...
                },
                {
                    perkRank: 4,
                    playerLevel: 50,
                    description: "Rad damage will now begin to slowly heal, restoring health in the process."
                }
            ]
        },
        SolarPowered: {
            ...
            attributeRank: "END 10",
            ranks: [
                {
                    perkRank: 1,
                    playerLevel: 0,
                    description: "Catch some rays! Gain +2 to Strength and Endurance between the hours of 6:00 a.m. and 6:00 p.m."
                },
                {
                    perkRank: 2,
                    playerLevel: 27,
    ...
    Charisma: {
        ...
        LadyKiller: { // or BlackWidow
            SPECIAL: "Charisma",
            perkName: "Lady Killer / Black Widow",
            attributeRank: "CHR 2",
            ranks: [
                {
                    perkRank: 1,
        ...
        LoneWanderer: {
            ...
            ranks: [
                ...
                },
                {
                    perkRank: 2,
                    playerLevel: 17,
                    description: "When adventuring without a companion, you take 30% less damage and carry weight increases by 100."
                },
                {
                    perkRank: 3,
                    playerLevel: 40,
                ...
                },
                {
                    perkRank: 4,
                    playerLevel: 50,
                    description: "When adventuring without a companion, you have 25 more action points."
                }
            ]
        },
        AttackDog: {
            ...
            ranks: [
                ...
                },
                {
                    perkRank: 4,
                    playerLevel: 31,
                    description: "When adventuring with your dog, you take 10% less damage."
                }
            ]
        },
        AnimalFriend: {
        ...
        VANS: {
            ...
            ranks: [
                ...
                },
                {
                    perkRank: 2,
                    playerLevel: 36,
                    description: "Gain +2 to Perception."
                }
            ]
        },
        Medic: {
        ...
        Scrapper: {
            ...
            ranks: [
                ...
                },
                {
                    perkRank: 3,
                    playerLevel: 40,
                    description: "You get more from salvaging. Appears to only apply to uncommon components, i.e., those affected by the first level of the perk."
                }
            ]
        },
        Science: {
        ...
        QuickHands: {
            ...
            ranks: [
                ...
                },
                {
                    perkRank: 3,
                    playerLevel: 40,
                    description: "Quick and efficient. You gain 10 additional Action Points."
                }
            ]
        },
        Blitz: {
            ...
            ranks: [
                {
                    perkRank: 1,
                    playerLevel: 0,
                    description: "You've learned to discover the Wasteland's hidden wealth, and discover more bottle caps in containers."
                },
                {
                    perkRank: 2,
                    playerLevel: 5,
            ...
            ranks: [
                {
                    perkRank: 1,
                    playerLevel: 0,
                    description: "You know just how to scavenge to keep the fight going, and find more ammunition in containers."
                },
                {
                    perkRank: 2,
                    playerLevel: 7,
                ...
                },
                {
                    perkRank: 4,
                    playerLevel: 37,
                    description: "There is a chance to gain ammo when firing the last round in your magazine."
                }
            ]
        },
        BloodyMess: {
        ...
        MysteriousStranger: {
            ...
            ranks: [
                ...
                },
                {
                    perkRank: 4,
                    playerLevel: 49,
                    description: "The Mysterious Stranger appears more often in V.A.T.S. When he kills an opponent, there is a high chance your Critical meter gets filled."
                }
            ]
        },
        IdiotSavant: {
            SPECIAL: "Luck",
            perkName: "Idiot Savant",
            attributeRank: "LCK 5",
            ranks: [
                {
                    perkRank: 1,
